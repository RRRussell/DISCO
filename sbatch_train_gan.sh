#!/bin/bash
#SBATCH --job-name=train_gan       # Job name
...
#SBATCH --output=./train_gan_1.log       # Standard output
#SBATCH --nodelist=galaxy

echo -e "Running train_gan on galaxy"
python "./script_train_gan.py" > ./train_gan_2.log